...
return {
  keys = {
    ...
    -- タブ
    --
    -- SHIFT+CTRL+tで新しいタブを開く
    -- SHIFT+CTRL+wで現在のタブを閉じる
    -- SHIFT+CTRL+1 ~ SHIFT+CTRL+8で対応位置のタブに移動
    -- SHIFT+CTRL+9で末尾のタブに移動
    -- CTRL+Tabで次の、SHIFT+CTRL+Tabで次のタブに移動
    -- ========================================
    ...
    -- スプリット
    --
    -- SHIFT+CTRL+hで水平スプリット
    -- SHIFT+CTRL+sで垂直スプリット
    -- SHIFT+CTRL+矢印キーでペインの移動
    -- SHIFT+CTRL+oで現在のペインを閉じる
    -- ========================================
    ...
    { key = 'o',          mods = 'SHIFT|CTRL', action = act.CloseCurrentPane { confirm = true } },
    { key = 'o',          mods = 'SUPER',      action = act.CloseCurrentPane { confirm = true } },
    { key = 'O',          mods = 'CTRL',       action = act.CloseCurrentPane { confirm = true } },
