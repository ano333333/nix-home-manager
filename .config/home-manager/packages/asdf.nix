...
pkgs.stdenv.mkDerivation {
  pname = "asdf-dist";
  version = "0.18.0";
  src = assert system == "x86_64-linux" ||  system == "aarch64-darwin"; if system == "x86_64-linux" then pkgs.fetchurl {
    ...
    url = "https://github.com/asdf-vm/asdf/releases/download/v0.18.0/asdf-v0.18.0-darwin-arm64.tar.gz";
